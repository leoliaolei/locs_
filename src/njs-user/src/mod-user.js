...
function initRoutes(server) {
    ...
    function initPassport(server) {
        ...
        server.get('/auth/:provider/callback', oauthCallback);
        ...
        function oauthCallback(req, res, next) {
            ...
            passport.authenticate(provider,
                 ...
                 * @param user {Account}
                 */
                function passportAuth(err, user) {
                    //logger.debug({user: user}, "oauthCallback");
                    ...
                    if (err)
                        ...
                        var body = '<script>' +
                            ...
                            'var extIds=["niknekdhkdjbkdbjchomiabflnkpkfeo","ikphkfkemdlgpgkhkpejlkecfddaohki","bbdbjionnefnjopmlbklojomfedlggcb"];' +
